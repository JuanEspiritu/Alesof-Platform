...
def run_seed():
    ...
    equipos = [
        ...
        Equipo(nombre="AWS Web Service", tipo="aws_resource", marca="AWS", modelo="Application Load Balancer", serie="AWS-ALB-WEB01", sede="AWS", vlan=None, ip="10.100.1.20", estado="activo"),
    ...
    tickets = [
        ...
        Ticket(titulo="Alerta de capacidad en ESXi-01", descripcion="El host ESXi-01 reporta consumo elevado de recursos y requiere revision del NOC.", cliente_id=3, tecnico_id=3, prioridad="crítica", estado="en_proceso"),
